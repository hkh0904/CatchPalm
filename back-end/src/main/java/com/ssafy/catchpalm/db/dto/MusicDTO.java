...
public class MusicDTO {
    ...
    public MusicDTO(int musicNumber, String musicName, String singer, String thumbnail, String level, String mp4Address, String backgroundAddress) {
    ...
    public static MusicDTO fromEntity(Music music) {
        ...
        ,music.getMp4Address(),music.getBackgroundAddress());
    }
}